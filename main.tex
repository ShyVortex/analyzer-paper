...
\thesistitle{Heuristic Analysis of Datasets for Lack of Comments Quality Identification} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
