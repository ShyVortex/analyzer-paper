...
In order to validate our heuristic, we concentrated on: \textit{CodeSearchNet} (CSN) \cite{CSN} and \textit{Automatically Generating Review Comments with Pre-training Models} (AUGER) \cite{AUGER}, both vastly used in literature, selecting from each two random samples of 384 instances.
